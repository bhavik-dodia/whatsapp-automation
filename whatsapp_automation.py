...
# create a new user profile in chrome and provide its path to user-data-dir so that it won't affect your main user profile and you need to scan the QR code only once
